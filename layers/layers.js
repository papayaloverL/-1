...
ol.proj.get("EPSG:3826").setExtent([125854.229578, 2515385.255600, 238097.192263, 2589733.841950]);
var wms_layers = [];
...
var lyr_4_4 = new ol.layer.Vector({
                ...
                style: style_4_4,
                interactive: true,
                title: '<img src="styles/legend/4_4.png" /> 公廁4'
            });
...
lyr_4_4.set('fieldAliases', {'id': 'id', 'toiletad_1': 'toiletad_1', 'pubtol_最': 'pubtol_最', });
lyr_2_2.set('fieldImages', {'編號': 'TextEdit', });
lyr_4_4.set('fieldImages', {'id': '', 'toiletad_1': '', 'pubtol_最': '', });
lyr_2_2.set('fieldLabels', {'編號': 'header label', });
lyr_4_4.set('fieldLabels', {'id': 'header label', 'toiletad_1': 'header label', 'pubtol_最': 'header label', });
lyr_4_4.on('precompose', function(evt) {
